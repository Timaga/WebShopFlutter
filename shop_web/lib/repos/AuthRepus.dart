...
class AuthRepository {
  ...
  Future<String> sendLogAuth(String password, String login, Dio dio) async {
    var url =
        'http://localhost:5071/api/Auth/login?login=${login}&password=${password}'; // Замените на свой URL
